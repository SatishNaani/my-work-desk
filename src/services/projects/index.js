...
const getBugTasksIds = () =>
    trackPromise(
        api.post(`_apis/wit/wiql?api-version=6.0`, {
            ...
            "query": "Select [System.Id], [System.Title], [System.State] From WorkItems Where [System.WorkItemType] = 'Bug' AND ( [State] = 'New'   OR [State] = 'Active' ) AND [Assigned To] = 'supriya.marri@vistex.com' order by [Microsoft.VSTS.Common.Priority] asc, [System.CreatedDate] desc"
